...
[source,java]
.prime-finder/src/main/java/example.micronaut.PrimeFinderService.java
----
include::{sourceDir}/prime-finder/src/main/java/example/micronaut/PrimeFinderService.java[]
----