...
NOTE: This is a guide for Micronaut 1.x. To get started w/ Micronaut 2.x, AWS Lambda, API Gateway & GraalVM, refer to
https://guides.micronaut.io/mn-application-aws-lambda-graalvm/guide/index.html[this guide], as the steps have changed fairly significantly.
